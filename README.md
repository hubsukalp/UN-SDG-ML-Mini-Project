...
* `ML_EDA_Report.pdf`: The initial Exploratory Data Analysis (EDA) report.
* `ML_Mini_Project.pptx`: Brief explaination regarding analysis and modeling did in the project.
* `Machine Learning Analysis of UN Sustainable Development Goals.docx`: Final mini project report containing all details.
